...
To find the top 5 songs most similar to the one selected by user by using their lyrics. I used cosine similarity model to obtain the result.

---

# 1. Most Common Words in Lyrics   
